              ...
              >
                <Card>
                  <Row gutter={[24, 24]}>
                    ...
                    {/* Right Column */}
                    <Col xs={24} md={16} className="cv1-main">
                      {/* Introduction */}
                      <div className="cv1-section">
                        <Title className="cv1-section__title" level={3}>
                          Giới thiệu
                        </Title>
                        <Form.Item
                          name="introduction"
                                ...
                                >
                                  ...
                                  <Form.Item
                                    ...
                                    rules={[
                                      {
                                        message:
                                          "Please enter the project period",
                                      },
                                    ]}
                                  >
                                ...
                                >
                                  ...
                                  <Form.Item
                                    ...
                                    rules={[
                                      {
                                        message:
                                          "Please enter the date received",
                                      },
                                    ]}
                                  >
